...
public class SwerveSubsystem extends SubsystemBase
{
   ...
   */
  public  double            maximumSpeed = Units.feetToMeters(8.5);
  /**
  ...
  public SwerveSubsystem(File directory)
  {
    ...
    double angleConversionFactor = 360;//SwerveMath.calculateDegreesPerSteeringRotation(50);
    ...
    double driveConversionFactor =
        SwerveMath.calculateMetersPerRotation(Units.inchesToMeters(4), 7.33);
  ...
  {
    //Fix for cubic scaling on raw axes
   /*  double xInput = translation.getX();
    double yInput = translation.getY();
    ...
    double xVelocity = magnitude * cos * swerveDrive.getMaximumVelocity();
    double yVelocity = magnitude * sin * swerveDrive.getMaximumVelocity(); */

    swerveDrive.drive(new Translation2d(translation.getX() * speedMultiplier, translation.getY() * speedMultiplier),
                      rotation,
                      fieldRelative,
